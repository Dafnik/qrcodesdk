...
| [`@qrcodesdk/cli`](https://qrcodesdk.dev/libs/cli/)         | Command line generation from terminals and scripts.   | Terminal text, SVG files, PNG files.                   |
...
- [CLI](https://qrcodesdk.dev/libs/cli/)
