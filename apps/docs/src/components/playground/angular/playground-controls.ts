...
import {type PlaygroundPackage, qrConfig, updateQrConfig} from '../playground-config.ts';
...
@Component({
    ...
    <div hlmField>
      ...
      <div
        ...
        <hlm-radio-group
          ...
          [attr.data-state]="currentConfig()?.packageName ?? 'react'"
          [ngModel]="currentConfig()?.packageName ?? 'react'"
  ...
  imports: [HlmRadioGroupImports, HlmLabelImports, HlmFieldImports, FormsModule, TitleCasePipe],
})
