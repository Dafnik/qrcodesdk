---
title: '@qrcodesdk/cli'
description: '@qrcodesdk/cli generates QR codes from a terminal, shell script, or CI job. The `qrc` command prints ANSI terminal text or writes SVG and PNG files.'
