...
<PackageManagerTabs packages={['@qrcodesdk/cli']} mode="exec" command="qrc" args={['"https://qrcodesdk.dev"']} />

Or use it without installing it.

<PackageManagerTabs packages={['@qrcodesdk/cli']} mode="dlx" command="qrc" args={['"https://qrcodesdk.dev"']} />
