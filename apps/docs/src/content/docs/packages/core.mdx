...
Compare all packages in [Choose your setup](/getting-started/choose-your-setup/#choose-a-package).
...
Core has no Node, DOM, filesystem, or framework dependency.
...
UTF-8. The UTF-8 ECI declaration is disabled by default.
...
- [Render SVG](/reference/renderers/svg/)
- [Render Terminal Text](/reference/renderers/text/)
